...
info<-legend("topright", lty="solid", plot=FALSE, pt.cex = 1, cex = 1, col=c("black","red","blue"), legend=c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"))
...
legend(x = c(leftx, rightx), y = c(topy, bottomy), lty="solid", pt.cex = 1, cex = 1,
